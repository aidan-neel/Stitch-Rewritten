...
<MainMenu width={43} clickOutsideFunction={() => {
    ...
    <div class="p-4 pl-6 mb-12 mt-2 flex flex-row">
        ...
        <button on:click={createPost} class="{validContent ? 'dark:text-sky-500 text-sky-600' : 'text-sky-800 hover:cursor-not-allowed'} duration-100 absolute bottom-6 right-6">
