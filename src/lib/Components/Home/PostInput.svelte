<script lang="ts">
    ...
    async function fetchData() {
        if(user && $currentUser) {
            ...
            console.log($currentUser.id, $currentUser, user)
...
{:else}
    <div class="w-full fadeUp px-5 mt-8 flex items-center justify-start h-20 border-b border-b-black/20 dark:border-b-white/10">
