...
<div bind:this={div} bind:innerText={value} on:input={handleInput} contenteditable="true" class="whitespace-pre-wrap break-words text-left z-20 w-[35rem] focus:outline-none dark:text-white/80 text-black/80"></div>
{#if content === ''}
